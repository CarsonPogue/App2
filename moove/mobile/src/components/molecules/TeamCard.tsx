...
export function TeamCard({ team, selected = false, onPress, disabled = false }: TeamCardProps) {
  ...
  return (
    ...
    >
      ...
      <Text variant="labelSmall" color={colors.text.muted} numberOfLines={1} style={styles.league}>
        {team.league}
      </Text>
    </TouchableOpacity>
  );
